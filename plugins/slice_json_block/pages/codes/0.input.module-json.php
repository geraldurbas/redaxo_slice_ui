...
<fieldset>
  ...
  <div class="block" data-json="1">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <textarea cols="1" rows="6" class="form-control rredactorEditor-full" id="rredactor_json_value_5_<?=$index;?>_fuenf" name="REX_INPUT_VALUE[5][<?=$index;?>][fuenf]"><?=$data['fuenf'];?></textarea>
      </div>
    </div>
